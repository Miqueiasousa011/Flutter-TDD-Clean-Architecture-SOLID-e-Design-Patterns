...
void main() {
  ...
  test('Should return error if value is less than min size ', () {
    final error =
        sut.validate({'any': faker.randomGenerator.string(4, min: 1)});
  ...
  test('Should return error if value is equal than min size ', () {
    final error =
        sut.validate({'any': faker.randomGenerator.string(5, min: 5)});
  ...
  test('Should return error if value is bigger than min size ', () {
    final error =
        sut.validate({'any': faker.randomGenerator.string(10, min: 6)});
